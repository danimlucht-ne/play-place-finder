...
@Composable
fun AdultTermsScreen(version: Int, onBack: () -> Unit) {
    ...
    Column(
        ...
        Text("Terms and Conditions (v$version)", fontSize = 22.sp, fontWeight = FontWeight.Bold)
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            TextButton(onClick = { openExternalUrl(MarketingLinks.termsOfService()) }) {
                Text("Terms on website", fontSize = 14.sp)
            }
            TextButton(onClick = { openExternalUrl(MarketingLinks.privacyPolicy()) }) {
                Text("Privacy on website", fontSize = 14.sp)
            }
        ...
        Text(
            "PLAY PLACE FINDER — PRIVACY POLICY & TERMS OF USE\n\n" +
            ...
            "- Content is user-generated or third-party supplied\n" +
            "- We do not verify all listings\n" +
            ...
            "4. LOCATION USAGE\n\n" +
            "By enabling location services, you consent to its use for:\n" +
            "- local search results\n" +
            "- nearby recommendations\n" +
            "- relevant advertising\n\n" +
            "You may disable location access at any time.\n\n" +
            "5. NO LIABILITY\n\n" +
            "To the fullest extent permitted by law:\n\n" +
            "We are not liable for:\n" +
            "- injuries or damages from visiting locations\n" +
            "- inaccurate or outdated information\n" +
            "- business practices of listed or advertised entities\n\n" +
            "Use of the app is at your own risk.\n\n" +
            "6. ADVERTISING TERMS (SUMMARY)\n\n" +
            "- Ads are paid placements\n" +
            "- Ads require approval before being shown\n" +
            "- Payment does not guarantee performance\n" +
            "- We may reject or remove ads\n\n" +
            "7. PAYMENTS\n\n" +
            "- Payments are handled by third-party processors\n" +
            "- Refunds are governed by our refund policy\n" +
            "- Active campaigns are generally non-refundable\n\n" +
            "8. CONTENT STANDARDS\n\n" +
            "You may not submit:\n" +
            ...
            "We reserve the right to review, moderate, remove, or restrict any content that:\n" +
            "- is inaccurate, misleading, or unsafe\n" +
            "- violates our content standards\n" +
            "- is reported by users\n\n" +
            "Users may report content through the app or by contacting us.\n\n" +
            "PLAIN SUMMARY\n\n" +
