...
async function discoverNewPlaces(db, region, options = {}) {
  ...
  // Then search around an adaptive grid to cover the entire region (including suburbs)
  const gridPoints = generateSearchGrid(center.lat, center.lng, { viewport: region.viewport });
