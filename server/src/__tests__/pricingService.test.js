...
describe('pricingService pure pricing helpers', () => {
  ...
  test('rounds event spotlight prices from monthly sponsored cents', () => {
    expect(roundEventSpotlightPriceFromMonthlyCents(9900, 'event_spotlight_7d')).toBe(2500);
    expect(roundEventSpotlightPriceFromMonthlyCents(9900, 'event_spotlight_14d')).toBe(5000);
